							...
							<table className="table">
								...
								<tbody>
									<tr className="text-center">
										...
										<td className="image-prod"><div className="img" style="background-image:url(images/product-3.jpg);"></div></td>
									...
									<tr className="text-center">
										...
										<td className="image-prod"><div className="img" style="background-image:url(images/product-4.jpg);"></div></td>
